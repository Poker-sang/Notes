...
\begin{longtblr}[
    ...
    colspec={c|Q[c,3em]|c|c|X[c]},
    hlines,
    cells={mode=dmath,valign=m}
    }
    \hline
    \text{待估参数}\theta                             & \text{条件}T                               & \text{枢轴变量}I                                                                             & \text{服从分布}F  & \text{双侧置信区间}\p{\hat\theta_1,\hat\theta_2}                                                                                                                                                                                                    \\
    \hline
    \SetCell[r=2]{c}\mu                           & \sigma^2\text{已知}                        & \frac{\bar X-\mu}{\sigma/\sqrt n}                                                        & N\p{0,1}      & \p{\bar X\pm\frac\sigma{\sqrt n}z_{\alpha/2}}                                                                                                                                                                                                 \\
                                                  & \sigma^2\text{未知}                        & \frac{\bar X-\mu}{S/\sqrt n}                                                             & t\p{n-1}      & \p{\bar X\pm\frac S{\sqrt n}t_{\alpha/2}\p{n-1}}                                                                                                                                                                                              \\
    \SetCell[r=2]{c}\sigma^2                      & \mu\text{已知}                             & \frac1{\sigma^2}\sumin{\p{X_i-\mu}}^2                                                    & \chi^2\p{n}   & \p{\frac{\sumin{\p{X_i-\mu}}^2}{\chi_{\alpha/2}^2\p{n}},\frac{\sumin{\p{X_i-\mu}}^2}{\chi_{1-\alpha/2}^2\p{n}}}                                                                                                                               \\
                                                  & \mu\text{未知}                             & \frac{\p{n-1}S^2}{\sigma^2}                                                              & \chi^2\p{n-1} & \p{\frac{\p{n-1}S^2}{\chi_{\alpha/2}^2\p{n-1}},\frac{\p{n-1}S^2}{\chi_{1-\alpha/2}^2\p{n-1}}}                                                                                                                                                 \\
    \hline
    \SetCell[r=2]{c}\mu_X-\mu_Y                   & \sigma_X^2,\sigma_Y^2\linebreak\text{已知} & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{\sqrt{\dfrac{\sigma_X^2}m+\dfrac{\sigma_Y^2}n}} & N\p{0,1}      & \p{\bar X-\bar Y\pm z_{\alpha/2}\sqrt{\frac{\sigma_X^2}m+\frac{\sigma_Y^2}n}}                                                                                                                                                                 \\
                                                  & \sigma_X^2,\sigma_Y^2\linebreak\text{未知} & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}}          & t\p{m+n-2}    & \left(\bar X-\bar Y\pm\right.\linebreak\left.t_{\alpha/2}\p{m+n-2}S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}\right)                                                                                                                                \\
    \SetCell[r=2]{c}\frac{\sigma_X^2}{\sigma_Y^2} & \mu_X,\mu_Y\linebreak\text{已知}           & \frac{\sum\limits_{i=1}^m\p{X_i-\mu_X}^2/m\sigma_X^2}{\sumin\p{Y_i-\mu_Y}^2/n\sigma_Y^2} & F\p{m,n}      & \left(\frac{\dfrac1m\sum\limits_{i=1}^m\p{X_i-\mu_X}^2}{\dfrac1n\sumin\p{Y_i-\mu_Y}^2F_{\alpha/2}\p{m,n}},\right.\linebreak\left.\frac{\dfrac1m\sum\limits_{i=1}^m\p{X_i-\mu_X}^2}{\dfrac1n\sumin\p{Y_i-\mu_Y}^2F_{1-\alpha/2}\p{m,n}}\right) \\
                                                  & \mu_X,\mu_Y\linebreak\text{未知}           & \frac{S_X^2/S_Y^2}{\sigma_X^2/\sigma_Y^2}                                                & F\p{m-1,n-1}  & \left(\frac{S_X^2}{S_Y^2}\cdot\frac1{F_{\alpha/2}\p{m-1,n-1}},\right.\linebreak\left.\frac{S_X^2}{S_Y^2}\cdot\frac1{F_{1-\alpha/2}\p{m-1,n-1}}\right)                                                                                         \\
    \hline
\end{longtblr}
...
\begin{longtblr}[
    ...
    \hline
    \text{原假设}H_0                 & \text{其他参数}T                                               & \text{检验统计量}I                                                                                     & \text{服从分布}F                  & \text{拒绝域}W                                                                                        \\
    \hline
    \mu=\mu_0                     & \SetCell[r=3]{c}\sigma^2\text{已知}                          & \SetCell[r=3]{c}U=\frac{\bar X-\mu_0}{\sigma/\sqrt n}                                             & \SetCell[r=3]{c}N\p{0,1}      & \abs u\geqslant u_{\alpha/2}                                                                       \\
    \mu\leqslant\mu_0             &                                                            &                                                                                                   &                               & u\geqslant u_{\alpha}                                                                              \\
    \mu\geqslant\mu_0             &                                                            &                                                                                                   &                               & u\leqslant-u_{\alpha}                                                                              \\
    \mu=\mu_0                     & \SetCell[r=3]{c}\sigma^2\text{未知}                          & \SetCell[r=3]{c}T=\frac{\bar X-\mu_0}{S/\sqrt n}                                                  & \SetCell[r=3]{c}t\p{n-1}      & \abs t\geqslant t_{\alpha/2}\p{n-1}                                                                \\
    \mu\leqslant\mu_0             &                                                            &                                                                                                   &                               & t\geqslant t_{\alpha}\p{n-1}                                                                       \\
    \mu\geqslant\mu_0             &                                                            &                                                                                                   &                               & t\leqslant-t_{\alpha}\p{n-1}                                                                       \\
    \sigma^2=\sigma_0^2           & \SetCell[r=3]{c}\mu\text{已知}                               & \SetCell[r=3]{c}\chi^2=\frac1{\sigma_0^2}\sumin{\p{X_i-\mu}}^2                                    & \SetCell[r=3]{c}\chi^2\p{n}   & \chi^2\geqslant\chi_{\alpha/2}^2\p{n}\text{或}\linebreak\chi^2\leqslant\chi_{1-\alpha/2}^2\p{n}     \\
    \sigma^2\leqslant\sigma_0^2   &                                                            &                                                                                                   &                               & \chi^2\geqslant\chi_{\alpha}^2\p{n}                                                                \\
    \sigma^2\geqslant\sigma_0^2   &                                                            &                                                                                                   &                               & \chi^2\leqslant\chi_{1-\alpha}^2\p{n}                                                              \\
    \sigma^2=\sigma_0^2           & \SetCell[r=3]{c}\mu\text{未知}                               & \SetCell[r=3]{c}\chi^2=\frac{\p{n-1}S^2}{\sigma_0^2}                                              & \SetCell[r=3]{c}\chi^2\p{n-1} & \chi^2\geqslant\chi_{\alpha/2}^2\p{n-1}\text{或}\linebreak\chi^2\leqslant\chi_{1-\alpha/2}^2\p{n-1} \\
    ...
    \hline
    \mu_X-\mu_Y=\delta            & \SetCell[r=3]{c}{\sigma_X^2,\sigma_Y^2\linebreak\text{已知}} & \SetCell[r=3]{c}U=\frac{\p{\bar X-\bar Y}-\delta}{\sqrt{\dfrac{\sigma_X^2}m+\dfrac{\sigma_Y^2}n}} & \SetCell[r=3]{c}N\p{0,1}      & \abs u\geqslant u_{\alpha/2}                                                                       \\
    \mu_X-\mu_Y\leqslant\delta    &                                                            &                                                                                                   &                               & u\geqslant u_{\alpha}                                                                              \\
    \mu_X-\mu_Y\geqslant\delta    &                                                            &                                                                                                   &                               & u\leqslant-u_{\alpha}                                                                              \\
    \mu_X-\mu_Y=\delta            & \SetCell[r=3]{c}{\sigma_X^2,\sigma_Y^2\linebreak\text{未知}} & \SetCell[r=3]{c}T=\frac{\p{\bar X-\bar Y}-\delta}{S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}}          & \SetCell[r=3]{c}t\p{m+n-2}    & \abs t\geqslant t_{\alpha/2}\p{m+n-2}                                                              \\
    \mu_X-\mu_Y\leqslant\delta    &                                                            &                                                                                                   &                               & t\geqslant t_{\alpha}\p{m+n-2}                                                                     \\
    \mu_X-\mu_Y\geqslant\delta    &                                                            &                                                                                                   &                               & t\leqslant-t_{\alpha}\p{m+n-2}                                                                     \\
    \sigma_X^2=\sigma_Y^2         & \SetCell[r=3]{c}{\mu_X,\mu_Y\linebreak\text{已知}}           & \SetCell[r=3]{c}F=\frac{\sum\limits_{i=1}^m\p{X_i-\mu_X}^2/m}{\sumin\p{Y_i-\mu_Y}^2/n}            & \SetCell[r=3]{c}F\p{m,n}      & F\geqslant F_{\alpha/2}\p{m,n}\text{或}\linebreak F\leqslant F_{1-\alpha/2}\p{m,n}                  \\
    \sigma_X^2\leqslant\sigma_Y^2 &                                                            &                                                                                                   &                               & F\geqslant F_{\alpha}\p{m,n}                                                                       \\
    \sigma_X^2\geqslant\sigma_Y^2 &                                                            &                                                                                                   &                               & F\leqslant F_{1-\alpha}\p{m,n}                                                                     \\
    \sigma_X^2=\sigma_Y^2         & \SetCell[r=3]{c}{\mu_X,\mu_Y\linebreak\text{未知}}           & \SetCell[r=3]{c}F=\frac{S_X^2}{S_Y^2}                                                             & \SetCell[r=3]{c}F\p{m-1,n-1}  & F\geqslant F_{\alpha/2}\p{m-1,n-1}\text{或}\linebreak F\leqslant F_{1-\alpha/2}\p{m-1,n-1}          \\
