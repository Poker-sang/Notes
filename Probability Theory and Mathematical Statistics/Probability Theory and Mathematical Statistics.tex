...
\begin{longtblr}[
    ...
    \hline
    \SetCell[r=2]{c}\mu_X-\mu_Y                   & \brl{\sigma_X^2,\sigma_Y^2}{\text{已知}}                                    & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{\sqrt{\dfrac{\sigma_X^2}m+\dfrac{\sigma_Y^2}n}} & N\p{0,1}      & \p{\bar X-\bar Y\pm z_{\alpha/2}\sqrt{\frac{\sigma_X^2}m+\frac{\sigma_Y^2}n}}                                                                                                                                                               \\
                                                  & \begin{gathered}\sigma_X^2=\\\sigma_Y^2=\sigma^2\\\text{未知}\end{gathered} & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}}          & t\p{m+n-2}    & \brl{\left(\bar X-\bar Y\pm\right.}{\left.t_{\alpha/2}\p{m+n-2}S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}\right)}                                                                                                                                \\
    \SetCell[r=2]{c}\frac{\sigma_X^2}{\sigma_Y^2} & \brl{\mu_X,\mu_Y}{\text{已知}}                                              & \frac{\sum\limits_{i=1}^m\p{X_i-\mu_X}^2/m\sigma_X^2}{\sumin\p{Y_i-\mu_Y}^2/n\sigma_Y^2} & F\p{m,n}      & \brl{\left(\frac{\dfrac1m\sum\limits_{i=1}^m\p{X_i-\mu_X}^2}{\dfrac1n\sumin\p{Y_i-\mu_Y}^2F_{\alpha/2}\p{m,n}},\right.}{\left.\frac{\dfrac1m\sum\limits_{i=1}^m\p{X_i-\mu_X}^2}{\dfrac1n\sumin\p{Y_i-\mu_Y}^2F_{1-\alpha/2}\p{m,n}}\right)} \\
                                                  & \brl{\mu_X,\mu_Y}{\text{未知}}                                              & \frac{S_X^2/S_Y^2}{\sigma_X^2/\sigma_Y^2}                                                & F\p{m-1,n-1}  & \brl{\left(\frac{S_X^2}{S_Y^2}\cdot\frac1{F_{\alpha/2}\p{m-1,n-1}},\right.}{\left.\frac{S_X^2}{S_Y^2}\cdot\frac1{F_{1-\alpha/2}\p{m-1,n-1}}\right)}                                                                                         \\
    \hline
\end{longtblr}
...
\begin{longtblr}[
    ...
    \sigma^2=\sigma_0^2           & \SetCell[r=3]{c}\mu\text{已知}                             & \SetCell[r=3]{c}\chi^2=\frac1{\sigma_0^2}\sumin{\p{X_i-\mu}}^2                                    & \SetCell[r=3]{c}\chi^2\p{n}   & \brl{\chi^2\geqslant\chi_{\alpha/2}^2\p{n}\text{或}}{\chi^2\leqslant\chi_{1-\alpha/2}^2\p{n}}     \\
    \sigma^2\leqslant\sigma_0^2   &                                                          &                                                                                                   &                               & \chi^2\geqslant\chi_{\alpha}^2\p{n}                                                              \\
    \sigma^2\geqslant\sigma_0^2   &                                                          &                                                                                                   &                               & \chi^2\leqslant\chi_{1-\alpha}^2\p{n}                                                            \\
    \sigma^2=\sigma_0^2           & \SetCell[r=3]{c}\mu\text{未知}                             & \SetCell[r=3]{c}\chi^2=\frac{\p{n-1}S^2}{\sigma_0^2}                                              & \SetCell[r=3]{c}\chi^2\p{n-1} & \brl{\chi^2\geqslant\chi_{\alpha/2}^2\p{n-1}\text{或}}{\chi^2\leqslant\chi_{1-\alpha/2}^2\p{n-1}} \\
    ...
    \hline
    \mu_X-\mu_Y=\delta            & \SetCell[r=3]{c}{\brl{\sigma_X^2,\sigma_Y^2}{\text{已知}}} & \SetCell[r=3]{c}U=\frac{\p{\bar X-\bar Y}-\delta}{\sqrt{\dfrac{\sigma_X^2}m+\dfrac{\sigma_Y^2}n}} & \SetCell[r=3]{c}N\p{0,1}      & \abs u\geqslant u_{\alpha/2}                                                                     \\
    \mu_X-\mu_Y\leqslant\delta    &                                                          &                                                                                                   &                               & u\geqslant u_{\alpha}                                                                            \\
    \mu_X-\mu_Y\geqslant\delta    &                                                          &                                                                                                   &                               & u\leqslant-u_{\alpha}                                                                            \\
    \mu_X-\mu_Y=\delta            & \SetCell[r=3]{c}{\brl{\sigma_X^2,\sigma_Y^2}{\text{未知}}} & \SetCell[r=3]{c}T=\frac{\p{\bar X-\bar Y}-\delta}{S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}}          & \SetCell[r=3]{c}t\p{m+n-2}    & \abs t\geqslant t_{\alpha/2}\p{m+n-2}                                                            \\
    \mu_X-\mu_Y\leqslant\delta    &                                                          &                                                                                                   &                               & t\geqslant t_{\alpha}\p{m+n-2}                                                                   \\
    \mu_X-\mu_Y\geqslant\delta    &                                                          &                                                                                                   &                               & t\leqslant-t_{\alpha}\p{m+n-2}                                                                   \\
    \sigma_X^2=\sigma_Y^2         & \SetCell[r=3]{c}{\brl{\mu_X,\mu_Y}{\text{已知}}}           & \SetCell[r=3]{c}F=\frac{\sum\limits_{i=1}^m\p{X_i-\mu_X}^2/m}{\sumin\p{Y_i-\mu_Y}^2/n}            & \SetCell[r=3]{c}F\p{m,n}      & \brl{F\geqslant F_{\alpha/2}\p{m,n}\text{或}}{F\leqslant F_{1-\alpha/2}\p{m,n}}                   \\
    \sigma_X^2\leqslant\sigma_Y^2 &                                                          &                                                                                                   &                               & F\geqslant F_{\alpha}\p{m,n}                                                                     \\
    \sigma_X^2\geqslant\sigma_Y^2 &                                                          &                                                                                                   &                               & F\leqslant F_{1-\alpha}\p{m,n}                                                                   \\
    \sigma_X^2=\sigma_Y^2         & \SetCell[r=3]{c}{\brl{\mu_X,\mu_Y}{\text{未知}}}           & \SetCell[r=3]{c}F=\frac{S_X^2}{S_Y^2}                                                             & \SetCell[r=3]{c}F\p{m-1,n-1}  & \brl{F\geqslant F_{\alpha/2}\p{m-1,n-1}\text{或}}{F\leqslant F_{1-\alpha/2}\p{m-1,n-1}}           \\
