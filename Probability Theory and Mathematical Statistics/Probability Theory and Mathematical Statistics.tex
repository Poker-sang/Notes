...
\begin{longtblr}[
    ...
    \SetCell[r=2]{c}\mu_X-\mu_Y                   & \brl{\sigma_X^2,\sigma_Y^2}{\text{已知}} & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{\sqrt{\dfrac{\sigma_X^2}m+\dfrac{\sigma_Y^2}n}} & N\p{0,1}      & \p{\bar X-\bar Y\pm z_{\alpha/2}\sqrt{\frac{\sigma_X^2}m+\frac{\sigma_Y^2}n}}                                                                                                                                                               \\
                                                  & \brl{\sigma_X^2,\sigma_Y^2}{\text{未知}} & \frac{\p{\bar X-\bar Y}-\p{\mu_X-\mu_Y}}{S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}}          & t\p{m+n-2}    & \brl{\left(\bar X-\bar Y\pm\right.}{\left.t_{\alpha/2}\p{m+n-2}S_\omega\cdot\sqrt{\dfrac1m+\dfrac1n}\right)}                                                                                                                                \\
