...
\[\bar x=\frac{\displaystyle\iint_Dx\rho\p{x,y}\d\sigma}{\displaystyle\iint_D\rho\p{x,y}\d\sigma},
    \bar x=\frac{\displaystyle\iiint_\Omega x\rho\p{x,y,z}\d\sigma}{\displaystyle\iiint_\Omega\rho\p{x,y,z}\d\sigma}\]
