...
\[\begin{tblr}{c|c|c}
        ...
        \hline
        \text{积分中值定理}     & f\pare{\xi}=\dfrac{\int_a^bf\pare x\d x}{\left.x\right|_a^b}                                              & \xi\in\left[a,b\right] \\
        \text{罗尔中值定理}     & f^\prime\pare{\xi}=0                                                                                                   & \xi\in\pare{a,b}       \\
        \text{拉格朗日中值定理} & f^\prime\pare{\xi}=\dfrac{\left.f\pare x\right|_a^b}{\left.x\right|_a^b}                                  & \xi\in\pare{a,b}       \\
        \text{柯西中值定理}     & \dfrac{f^\prime\pare{\xi}}{g^\prime\pare{\xi}}=\dfrac{\left.f\pare x\right|_a^b}{\left.g\pare x\right|_a^b} & \xi\in\pare{a,b}       \\
        \hline
    \end{tblr}\]
